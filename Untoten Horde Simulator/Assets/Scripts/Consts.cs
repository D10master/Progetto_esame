...
public static class Consts
{
    ...
    public const float ZOMBIE_MIN_SPEED = 1.25f;
    public const float ZOMBIE_MAX_SPEED = 2.8f;
    public const float ZOMBIE_RUNNING_SPEED = 1.8f;

    public const int ZOMBIE_MIN_ATTACK = 250;
    public const int ZOMBIE_MAX_ATTACK = 600;
